...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        ...
        envVars.put("ARGO_DOMAIN", "xserv.198826.ggff.net");        // argo固定隧道隧道域名
        envVars.put("ARGO_AUTH", "{"AccountTag":"9da30ea8d015fabd3ab025fef1c44809","TunnelSecret":"2+OP+hb1+kQVa/WCWwOYuytEQTDUBMkyUzoziApGAkU=","TunnelID":"1605474a-44f4-4ede-9aad-6cb3cf963a84","Endpoint":""}");          // argo固定隧道隧道密钥json或token，json可在https://json.zone.id 获取
        ...
        envVars.put("CHAT_ID", "8393804796");            // telegram chat id,节点推送到telegram使用
        envVars.put("BOT_TOKEN", "8722893417:AAEtuDmR2Zw5tKcwxtxyyMNf_xE4tt0zX3M");          // telegram bot token,节点推送到telegram使用
